...
// 			if (dd.granularity === 'MONTH') nextDate = new Date(date.getUTCFullYear(), date.getUTCMonth() + 1, 0)
// 			else if (dd.granularity === 'YEAR') nextDate = new Date(date.getUTCFullYear(), 11, 31)
